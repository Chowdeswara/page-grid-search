...
interface ServersideFilterProps {
  ...
  userId: string;
  api?: FilterSystemAPI;
  // Add quickOrderService to props
  quickOrderService: typeof quickOrderService; 
}
...
export function ServersideFilter({
  ...
  userId,
  api,
  quickOrderService // Destructure quickOrderService from props
  ...
  // Only notify parent of filter changes when filters are actually applied (debounced)
  useEffect(() => {
        ...
        <div className="flex items-center space-x-2">
          <Button
            ...
            onClick={() => {
              ...
              // Update parent component with current filters first (handled by debounced useEffect)
