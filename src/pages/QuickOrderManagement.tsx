...
const QuickOrderManagement = () => {
  ...
  // const [serverFilterOptions, setServerFilterOptions] = useState<any>({}); // No longer needed as options are fetched on demand
  const [filtersLoading, setFiltersLoading] = useState(false);

  // Remove the useEffect that fetches all filter options
  // useEffect(() => {
  ...
  const dynamicServerFilters: ServerFilter[] = useMemo(() => [
    { key: 'OrderType', label: 'Order Type', type: 'select', options: [
              { id: '1', name: 'BOTH', default: "N", description: "", seqNo: 1 },
              { id: '2', name: 'SELL', default: "N", description: "", seqNo: 2 },
              { id: '3', name: 'BUY', default: "N", description: "", seqNo: 3 },
    ] },
    { key: 'Supplier', label: 'Supplier', type: 'select', messageType: 'Supplier Init' },
    { key: 'Contract', label: 'Supplier/Customer Contract', type: 'select', messageType: 'Contract Init' },
    { key: 'Cluster', label: 'Cluster', type: 'select', messageType: 'Cluster Init' },
    { key: 'Customer', label: 'Customer', type: 'select', messageType: 'Customer Init' },
    { key: 'CustomerSupplierRefNo', label: 'Customer/Supplier Ref No', type: 'text' },
    { key: 'DraftBillNo', label: 'Draft Bill No', type: 'text' },
    { key: 'DeparturePoint', label: 'Departure Point', type: 'select', messageType: 'Departure Init' },
    { key: 'ArrivalPoint', label: 'Arrival Point', type: 'select', messageType: 'Arrival Init' },
    { key: 'ServiceType', label: 'Service', type: 'select', messageType: 'Service type Init' },
    ...
    { key: 'DraftBillStatus', label: 'Draft Bill Status', type: 'select', messageType: 'DraftBillStatus Init' },
    { key: 'IsBillingFailed', label: 'Billing Failed', type: 'select', options: [
      { id: '1', name: 'Yes', default: "N", description: "", seqNo: 1 },
      { id: '2', name: 'No', default: "N", description: "", seqNo: 2 }
    ] },
    { key: 'SubService', label: 'Sub Service', type: 'select', messageType: 'Sub Service type Init' },
    { key: 'WBS', label: 'WBS', type: 'text' },
    { key: 'OperationalLocation', label: 'Operational Location', type: 'select', messageType: 'Location Init' },
    ...
    { key: 'CreatedBy', label: 'Quick Order Created By', type: 'select', messageType: 'Createdby Init' },
    { key: 'SecondaryDoc', label: 'Secondary Doc', type: 'dropdownText' },
    { key: 'InvoiceNo', label: 'Invoice No', type: 'text' },
    { key: 'InvoiceStatus', label: 'Invoice Status', type: 'select', messageType: 'Finance Status Init' },
    { key: 'ResourceType', label: 'Resource Type', type: 'select', messageType: 'ResourceType Init' },
    { key: 'Wagon', label: 'Wagon', type: 'select', messageType: 'Wagon type Init' },
    { key: 'Container', label: 'Container', type: 'select', messageType: 'Container Type Init' },
  ], []);
